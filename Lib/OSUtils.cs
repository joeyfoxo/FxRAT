...
public class OSUtils
{
        ...
        try
        {
            ...
            ManagementObjectSearcher driveSearcher =
                new ManagementObjectSearcher(
                    "SELECT * FROM Win32_LogicalDisk WHERE DriveType=3"); // DriveType 3 is for local disks
    ...
    public static List<string> GetFileSystemInformation()
    {
        ...
        fileSystemInfo.Add(
            $"Downloads Folder: {Environment.GetFolderPath(Environment.SpecialFolder.UserProfile)}\\Downloads");
